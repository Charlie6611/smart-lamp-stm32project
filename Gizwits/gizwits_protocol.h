...
* @{
*/
#define PRODUCT_KEY "3d5c1f95e7254862ac5b2a7fb9d35e47"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "6c221a544e854a4b8d3a74272ebb1362"
...
#define MAX_PACKAGE_LEN    (sizeof(devStatus_t)+sizeof(dataPointFlags_t)+270)    ///< Data buffer maximum length
...
#define Humidity_LEN                           1
#define distance_RATIO                         1
#define distance_ADDITION                      0
#define distance_MIN                           0
#define distance_MAX                           99
#define distance_LEN                           1
#define Lamp_brightness_RATIO                         1
#define Lamp_brightness_ADDITION                      0
#define Lamp_brightness_MIN                           0
#define Lamp_brightness_MAX                           100
#define Lamp_brightness_LEN                           1
#define Distance_threshold_RATIO                         1
#define Distance_threshold_ADDITION                      0
#define Distance_threshold_MIN                           0
#define Distance_threshold_MAX                           99
#define Distance_threshold_LEN                           1
#define Lux_RATIO                         1
#define Lux_ADDITION                      0
#define Lux_MIN                           0
#define Lux_MAX                           999
#define Lux_LEN                           2
#define Illumination_threshold_RATIO                         1
#define Illumination_threshold_ADDITION                      0
#define Illumination_threshold_MIN                           0
#define Illumination_threshold_MAX                           999
#define Illumination_threshold_LEN                           2
...
typedef enum
{
    body_recognition_VALUE0 = 0,//无人
    body_recognition_VALUE1 = 1,//有人
    body_recognition_VALUE_MAX,
} body_recognition_ENUM_T;
...
typedef enum
{
    ...
    EVENT_Model,
    EVENT_Lamp_brightness,
    EVENT_Distance_threshold,
    EVENT_Illumination_threshold,
...
typedef struct {
    uint32_t valueModel;
    uint32_t valuebody_recognition;
    uint32_t valueTemperature;
    uint32_t valueHumidity;
    uint32_t valuedistance;
    uint32_t valueLamp_brightness;
    uint32_t valueDistance_threshold;
    uint32_t valueLux;
    uint32_t valueIllumination_threshold;
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
    uint8_t flagModel:1;
    uint8_t flagbody_recognition:1;
    uint8_t flagTemperature:1;
    uint8_t flagHumidity:1;
    uint8_t flagdistance:1;
    uint8_t flagLamp_brightness:1;
    uint8_t flagDistance_threshold:1;
    uint8_t flagLux:1;
    uint8_t flagIllumination_threshold:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valuedistance;
    uint8_t valueLamp_brightness;
    uint8_t valueDistance_threshold;
    uint16_t valueLux;
    uint16_t valueIllumination_threshold;
} devStatus_t;
